        	...
        	<div class="search-filter-area d-flex justify-content-md-between justify-content-center align-items-center flex-wrap gr-15">
              ...
              <div class="position-relative">
                ...
                >
                  ...
                  <li>
                      <a class="dropdown-item" id="print" href="javascript:;" onclick="printableDiv('package_list')"><?php echo e(get_phrase('Print')); ?></a>
                  </li>
                </ul>
              </div>
              <?php endif; ?>
	                		...
	                		<tr>
	                			...
	                			<td class="text-start">
	                				<div class="adminTable-action">
	                                    ...
	                                    >
	                                      <li>
	                                        <a class="dropdown-item" href="javascript:;" onclick="rightModal('<?php echo e(route('superadmin.edit.package', ['id' => $package->id])); ?>', 'Edit Package')"><?php echo e(get_phrase('Edit')); ?></a>
	                                      </li>
	                                      <li>
	                                        <a class="dropdown-item" href="javascript:;" onclick="confirmModal('<?php echo e(route('superadmin.package.delete', ['id' => $package->id])); ?>', 'undefined');"><?php echo e(get_phrase('Delete')); ?></a>
	                                      </li>
	                                    </ul>
	                                </div>
			                    </td>
...
<?php if(count($packages) > 0): ?>
<div class="table-responsive package_list display-none-view" id="package_list">
	<table class="table eTable">
		<thead>
            <th>#</th>
            <th><?php echo e(get_phrase('Package')); ?></th>
...
<script type="text/javascript">
  ...
  function Export() {
      ...
      const element = document.getElementById("package_list");
    ...
    var opt = {
      margin:       1,
      filename:     'package_list_<?php echo e(date("y-m-d")); ?>.pdf',
...
<?php echo $__env->make('superadmin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ekattor/Ekattor8/resources/views/superadmin/package/package.blade.php ENDPATH**/ ?>
      ...
      <div class="col-12">
        ...
        >
          <div class="d-flex flex-column">
            <h4><?php echo e(get_phrase('Teachers')); ?></h4>
            <ul class="d-flex align-items-center eBreadcrumb-2">
              <li><a href="#"><?php echo e(get_phrase('Home')); ?></a></li>
              <li><a href="#"><?php echo e(get_phrase('Users')); ?></a></li>
              <li><a href="#"><?php echo e(get_phrase('Teacher')); ?></a></li>
            </ul>
          </div>
          <div class="export-btn-area">
            <a href="javascript:;" class="export_btn" onclick="rightModal('<?php echo e(route('admin.teacher.open_modal')); ?>', '<?php echo e(get_phrase('Create Teacher')); ?>')"><?php echo e(get_phrase('Create Teacher')); ?></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-12">
        <div class="eSection-wrap-2">
            <div class="search-filter-area d-flex justify-content-md-between justify-content-center align-items-center flex-wrap gr-15">
              <form action="<?php echo e(route('admin.teacher')); ?>">
                <div
              ...
              <div class="position-relative">
                ...
                >
                  ...
                  <li>
                      <a class="dropdown-item" id="print" href="javascript:;" onclick="printableDiv('teacher_list')"><?php echo e(get_phrase('Print')); ?></a>
                  </li>
                </ul>
              </div>
              <?php endif; ?>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="adminTable-action">
                            ...
                            >
                              <li>
                                <a class="dropdown-item" href="javascript:;" onclick="rightModal('<?php echo e(route('admin.teacher_edit_modal', ['id' => $teacher->id])); ?>', '<?php echo e(get_phrase('Edit Admin')); ?>')"><?php echo e(get_phrase('Edit')); ?></a>
                              </li>
                              <li>
                                <a class="dropdown-item" href="javascript:;" onclick="confirmModal('<?php echo e(route('admin.teacher.delete', ['id' => $teacher->id])); ?>', 'undefined');"><?php echo e(get_phrase('Delete')); ?></a>
                              </li>
                            </ul>
                          </div>
                        </td>
...
<script type="text/javascript">
  ...
  function Export() {
    ...
    var opt = {
      margin:       1,
      filename:     'teacher_list_<?php echo e(date("y-m-d")); ?>.pdf',
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ekattor/Ekattor8/resources/views/admin/teacher/teacher_list.blade.php ENDPATH**/ ?>
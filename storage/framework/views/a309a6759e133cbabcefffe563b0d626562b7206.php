              ...
              <div class="col-md-12">
                <form class="form-horizontal form-groups" method="post"
                  ...
                  <div class="form-group">
            				...
            				<div class="col-sm-5">
            					<input type="text" class="form-control eForm-control" name="current_session" placeholder="Ex: 2020"
                        required autofocus>
            				</div>
                    <div class="col-sm-4 ins-six">
                      <?php echo e(phrase('Current Academic Session Example: 2022')); ?>
...
<?php echo $__env->make('install.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ekattor/Ekattor8/resources/views/install/finalizing_setup.blade.php ENDPATH**/ ?>
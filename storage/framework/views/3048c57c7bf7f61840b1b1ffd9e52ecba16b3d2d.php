             ...
             <div class="row">
                <div class="row justify-content-md-center">
                    ...
                    <div class="col-xl-2 mb-3">
                        <button type="button" class="eBtn eBtn btn-secondary form-control" onclick="filter_marks()"><?php echo e(get_phrase('Filter')); ?></button>
                    </div>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ekattor/Ekattor8/resources/views/admin/marks/index.blade.php ENDPATH**/ ?>
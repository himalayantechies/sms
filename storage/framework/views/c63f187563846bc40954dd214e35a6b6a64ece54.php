...
<body>
    ...
    <ul class="nav-links">
      ...
      <li class="nav-links-li <?php echo e(request()->is('superadmin/class_list*') || request()->is('superadmin/subject/subjects*') || request()->is('superadmin/grade*')  ? 'showMenu':''); ?>">
        <div class="iocn-link">
            <a href="#">
                <div class="sidebar_icon">
                ...
                <span class="link_name"><?php echo e(get_phrase('Academic')); ?></span>
            </a>
            <span class="arrow">
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <ul class="sub-menu">
            <li><a class="<?php echo e((request()->is('superadmin/class_list*')) ? 'active' : ''); ?>" href="<?php echo e(route('superadmin.class_list')); ?>"><span><?php echo e(get_phrase('Class List')); ?></span></a></li>
            <li><a class="<?php echo e((request()->is('superadmin/subject*')) ? 'active' : ''); ?>" href="<?php echo e(route('superadmin.subject_list')); ?>"><span><?php echo e(get_phrase('Subjects')); ?></span></a></li>
            <li><a class="<?php echo e((request()->is('superadmin/grade*')) ? 'active' : ''); ?>" href="<?php echo e(route('superadmin.grade_list')); ?>"><span><?php echo e(get_phrase('Grade')); ?></span></a></li>
        </ul>
    </li>

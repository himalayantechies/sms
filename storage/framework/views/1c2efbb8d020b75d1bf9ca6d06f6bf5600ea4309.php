...
<body>
    ...
    <div class="sidebar">
        <div class="logo-details mt-4 mb-3">
            <div class="img_wrapper">
                <img height="40px" class=""
                    src="<?php echo e(asset('public/assets/uploads/logo/' . get_settings('light_logo'))); ?>" alt="" />
            </div>
        </div>
        <div class="closeIcon">
        ...
        <ul class="nav-links">
            ...
            <!-- Sidebar menu -->
            <li
                class="nav-links-li <?php echo e(request()->is('admin/admin*') || request()->is('admin/teacher*') || request()->is('admin/accountant*') || request()->is('admin/librarian*') || request()->is('admin/parent*') || request()->is('admin/student') || request()->is('admin/permission*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li><a class="<?php echo e(request()->is('admin/admin*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.admin')); ?>"><span>
                                <?php echo e(get_phrase('Admin')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('admin/teacher*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.teacher')); ?>"><span>
                                <?php echo e(get_phrase('Teacher')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('admin/accountant*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.accountant')); ?>"><span>
                                <?php echo e(get_phrase('Accountant')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('admin/librarian*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.librarian')); ?>"><span>
                                <?php echo e(get_phrase('Librarian')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('admin/parent*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.parent')); ?>"><span>
                                <?php echo e(get_phrase('Parent')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('admin/student') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.student')); ?>"><span>
                                <?php echo e(get_phrase('Student')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('admin/permission*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.teacher.permission')); ?>"><span>
            ...
            <li class="nav-links-li <?php echo e(request()->is('admin/offline_admission*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a class="<?php echo e(request()->is('admin/offline_admission*') ? 'active' : ''); ?>"
                        href="<?php echo e(route('admin.offline_admission.single', ['type' => 'single'])); ?>">
                        <div class="sidebar_icon">
            ...
            <li
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a class="<?php echo e(request()->is('admin/offline_exam*') ? 'active' : ''); ?>"
            ...
            <li
                class="nav-links-li <?php echo e(request()->is('admin/attendance*') || request()->is('admin/class_list*') || request()->is('admin/routine*') || request()->is('admin/subject*') || request()->is('admin/syllabus*') || request()->is('admin/gradebook*') || request()->is('admin/class_room*') || request()->is('admin/department*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                ...
                <ul class="sub-menu">
                    <li><a class="<?php echo e(request()->is('admin/attendance*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.daily_attendance')); ?>"><span>
                                <?php echo e(get_phrase('Daily Attendance')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('admin/class_list*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.class_list')); ?>"><span>
                                <?php echo e(get_phrase('Class List')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('admin/routine*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.routine')); ?>"><span>
                                <?php echo e(get_phrase('Class Routine')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('admin/subject*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.subject_list')); ?>"><span>
                                <?php echo e(get_phrase('Subjects')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('admin/gradebook*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.gradebook')); ?>"><span>
                                <?php echo e(get_phrase('Gradebooks')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('admin/syllabus*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.syllabus')); ?>"><span>
                                <?php echo e(get_phrase('Syllabus')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('admin/class_room*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.class_room_list')); ?>"><span>
                                <?php echo e(get_phrase('Class Room')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('admin/department*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.department_list')); ?>"><span>
            ...
            <li
                class="nav-links-li <?php echo e(request()->is('admin/fee_manager*') || request()->is('admin/offline_payment/pending*') || request()->is('admin/expense_category*') || request()->is('admin/expenses*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                ...
                <ul class="sub-menu">
                    <li><a class="<?php echo e(request()->is('admin/fee_manager') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.fee_manager.list')); ?>"><span>
                                <?php echo e(get_phrase('Student Fee Manager')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('admin/offline_payment/pending*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.offline_payment_pending')); ?>"><span>
                                <?php echo e(get_phrase('Offline Payment Request')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('admin/expenses*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.expense.list')); ?>"><span>
                                <?php echo e(get_phrase('Expense Manager')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('admin/expense_category*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.expense.category_list')); ?>"><span>
            ...
            <?php if(addon_status('online_bundles') == 1 && addon_status('online_courses') == 1): ?>
                <li class="nav-links-li <?php echo e(request()->is('admin/addons/courses*') ? 'showMenu' : ''); ?>">
                    <div class="iocn-link">
                        <a class="<?php echo e(request()->is('admin/addons/courses*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.addons.courses')); ?>">
                            <div class="sidebar_icon">
            ...
            <?php if(addon_status('hr_management') == 1): ?>
                ...
                <li
                    class="nav-links-li <?php echo e(request()->is('hr/leave_list*') || request()->is('payroll/create/payslip*') || request()->is('attendence/list*') || request()->is('payroll/list*') || request()->is('hr/user/roles*') || request()->is('hr/user/list*') ? 'showMenu' : ''); ?>">
                    <div class="iocn-link">
                        <a href="#">
                            <div class="sidebar_icon">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a class="<?php echo e(request()->is('hr/user/roles*') ? 'active' : ''); ?>"
                                href="<?php echo e(route('hr.user_role_index')); ?>">
                                <span>
                        ...
                        <li>
                            <a class="<?php echo e(request()->is('hr/user/list*') ? 'active' : ''); ?>"
                                href="<?php echo e(route('hr.userlist_index')); ?>">
                                <span>
                        ...
                        <li>
                            <a class="<?php echo e(request()->is('attendence/list*') ? 'active' : ''); ?>"
                                href="<?php echo e(route('hr.list_of_attendence')); ?>">
                                <span>
                        ...
                        <li>
                            <a class="<?php echo e(request()->is('hr/leave_list*') ? 'active' : ''); ?>"
                                href="<?php echo e(route('hr.list_of_leaves')); ?>">
                                <span>
                        ...
                        <li>
                            <a class="<?php echo e(request()->is('payroll/list*') ? 'active' : ''); ?>"
                                href="<?php echo e(route('hr.list_of_payrolls')); ?>">
                                <span>
            ...
            <li
                class="nav-links-li <?php echo e(request()->is('admin/book*') || request()->is('admin/book_issue*') || request()->is('admin/noticeboard*') || request()->is('admin/subscription') || request()->is('admin/events/list*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li><a class="<?php echo e(request()->is('admin/book/list') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.book.book_list')); ?>"><span>
                                <?php echo e(get_phrase('Book List Manager')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('admin/book_issue') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.book_issue.list')); ?>"><span>
                                <?php echo e(get_phrase('Book Issue Report')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('admin/noticeboard*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.noticeboard.list')); ?>"><span>
                                <?php echo e(get_phrase('Noticeboard')); ?>

                            </span></a></li>
                    <li><a class="<?php echo e(request()->is('admin/subscription') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.subscription')); ?>"><span>
                                <?php echo e(get_phrase('Subscription')); ?>

                            </span></a></li>
                    <li>
                        <a class="<?php echo e(request()->is('admin/events/list*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.events.list')); ?>"><span><?php echo e(get_phrase('Events')); ?>
            ...
            <li
                class="nav-links-li <?php echo e(request()->is('admin/settings/school*') || request()->is('admin/session_manager*') || request()->is('admin/settings/payment*') || request()->is('admin/live_class_settings*') || request()->is('admin/profile*') ? 'showMenu' : ''); ?>">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="<?php echo e(request()->is('admin/settings/school*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.settings.school')); ?>">
                            <span>
                    ...
                    <li>
                        <a class="<?php echo e(request()->is('admin/session_manager*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.settings.session_manager')); ?>">
                            <span>
                    ...
                    <li>
                        <a class="<?php echo e(request()->is('admin/settings/payment*') ? 'active' : ''); ?>"
                            href="<?php echo e(route('admin.settings.payment')); ?>">
                            <span>
                    ...
                    <?php if(addon_status('online_bundles') == 1 && addon_status('online_live_class') == 1): ?>
                        <li>
                            <a class="<?php echo e(request()->is('admin/live_class_settings*') ? 'active' : ''); ?>"
                                href="<?php echo e(route('admin.live_class_key')); ?>">
                                <span>
                    ...
                    <li><a class="<?php echo e(request()->is('admin/profile*') ? 'active' : ''); ?>"
                                ...
                                <li class="user-profile">
                                    <div class="btn-group">
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            aria-expanded="false">
                                            <div class="">
                                                <img src="<?php echo e(get_user_image(auth()->user()->id)); ?>"
                                                    height="42px" />
                                            </div>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end eDropdown-menu"
                                            ...
                                            <!-- Logout Button -->
                                            <li>
                                                <a class="btn eLogut_btn" href="<?php echo e(route('logout')); ?>"
            ...
            <div class="main_content">
                ...
                <div class="copyright-text">
                    <?php $active_session = DB::table('sessions')
                        ...
                        ->value('session_title'); ?>
                    <p><?php echo e($active_session); ?> &copy; <span><a class="text-info" target="_blank"
                                href="<?php echo e(get_settings('footer_link')); ?>"><?php echo e(get_settings('footer_text')); ?></a></span>
                    </p>
                </div>
                <!-- End Footer -->
            </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/sms/resources/views/admin/navigation.blade.php ENDPATH**/ ?>
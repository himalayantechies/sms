      ...
      <div class="col-12">
        ...
        >
          ...
          <div class="export-btn-area">
            <a href="javascript:;" class="export_btn" onclick="rightModal('<?php echo e(route('superadmin.class.open_modal')); ?>', '<?php echo e(get_phrase('Create Class')); ?>')"><?php echo e(get_phrase('Add class')); ?></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-7 offset-md-2">
        <div class="eSection-wrap">
            <div class="search-filter-area d-flex justify-content-md-between justify-content-center align-items-center flex-wrap gr-15">
              <form action="<?php echo e(route('superadmin.class_list')); ?>">
                <div
            ...
            <div class="table-responsive">
                  <table class="table eTable">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $class_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class_list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <tr>
                                ...
                                <td class="text-start">
                                    <div class="adminTable-action">
                                        ...
                                        >
                                          ...
                                          <li>
                                            <a class="dropdown-item" href="javascript:;" onclick="rightModal('<?php echo e(route('superadmin.edit.class', ['id' => $class_list->id])); ?>', '<?php echo e(get_phrase('Edit Class')); ?>')"><?php echo e(get_phrase('Edit Class')); ?></a>
                                          </li>
                                          <li>
...
<?php echo $__env->make('superadmin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/sms/resources/views/superadmin/class/class_list.blade.php ENDPATH**/ ?>
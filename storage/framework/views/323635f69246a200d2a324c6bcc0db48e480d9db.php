            ...
            <div class="col-12 p-4">
                ...
                <p class="border-bottom mb-2 pb-2 text-13px">
                  ...
                  <?php if($application_details['product_license'] == 'valid'): ?>
                    <span class="float-end badge bg-success text-capitalize"><?php echo e($application_details['product_license']); ?></span>
                  <?php else: ?>
                    <span class="float-end badge bg-danger mt-1 text-capitalize"><?php echo e($application_details['product_license']); ?></span>
                    <button class="btn btn-primary float-end me-2 py-0 text-13px" onclick="rightModal('<?php echo e(route('superadmin.save_valid_purchase_code', ['action_type' => 'show'])); ?>', '<?php echo e(get_phrase('Enter valid purchase code')); ?>');"><?php echo e(get_phrase('Enter valid purchase code')); ?></button>
                  <?php endif; ?>
                </p>
                <p class="border-bottom mb-2 pb-2 text-13px">
                ...
                <p class="border-bottom mb-2 pb-2 text-13px">
                  <i class="bi bi-arrow-right-square me-3"></i> <?php echo e(get_phrase('Support expiry date')); ?>
                    ...
                    <?php else: ?>
                        <span class="float-end"><span class="badge bg-danger"><?php echo e(ucfirst($application_details['support_expiry_date'])); ?></span></span>
                    <?php endif; ?>
                </p>
                <p class="border-bottom mb-2 pb-2 text-13px">
                  ...
                  <?php else: ?>
                      <span class="float-end"><span class="badge bg-danger"><?php echo e(ucfirst($application_details['customer_name'])); ?></span></span>
                  <?php endif; ?>
                </p>
                <p class="border-bottom mb-2 pb-2 text-13px">
...
<?php echo $__env->make('superadmin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ekattor/Ekattor8/resources/views/superadmin/settings/about.blade.php ENDPATH**/ ?>
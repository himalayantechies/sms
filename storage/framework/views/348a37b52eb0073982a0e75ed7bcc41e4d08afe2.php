<div class="eForm-layouts">
    <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('admin.teacher.create')); ?>">
        <?php echo csrf_field(); ?> 
        <div class="form-row">
            <div class="fpb-7">
...
</script><?php /**PATH /var/www/html/ekattor/Ekattor8/resources/views/admin/teacher/add_teacher.blade.php ENDPATH**/ ?>
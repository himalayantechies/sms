      ...
      <div class="col-12">
        ...
        >
          ...
          <div class="export-btn-area">
            <a href="javascript:;" class="export_btn" onclick="rightModal('<?php echo e(route('superadmin.subject.open_modal')); ?>', '<?php echo e(get_phrase('Create Subject')); ?>')"><i class="bi bi-plus"></i><?php echo e(get_phrase('Add subject')); ?></a>
          </div>
        </div>
      </div>
    </div>
                             ...
                             <tr>
                                ...
                                <td class="text-start">
                                    <div class="adminTable-action">
                                        ...
                                        >
                                          <li>
                                            <a class="dropdown-item" href="javascript:;" onclick="rightModal('<?php echo e(route('superadmin.edit.subject', ['id' => $subject->id])); ?>', '<?php echo e(get_phrase('Edit Subject')); ?>')"><?php echo e(get_phrase('Edit')); ?></a>
                                          </li>
                                          <li>
                                            <a class="dropdown-item" href="javascript:;" onclick="confirmModal('<?php echo e(route('superadmin.subject.delete', ['id' => $subject->id])); ?>', 'undefined');"><?php echo e(get_phrase('Delete')); ?></a>
                                          </li>
                                        </ul>
                                    </div>
                                </td>

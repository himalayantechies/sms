<div class="eoff-form">
    <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('superadmin.create.subject')); ?>">
         <?php echo csrf_field(); ?> 
        <div class="form-row">
            <div class="fpb-7">
            ...
            <div class="fpb-7 pt-2">
                <button class="btn-form" type="submit"><?php echo e(get_phrase('Create Subject')); ?></button>
            </div>
        </div>
    </form>
</div>
...
</script><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/sms/resources/views/superadmin/subject/add_subject.blade.php ENDPATH**/ ?>
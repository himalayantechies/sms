    ...
    <div class="col-12">
        <div class="eSection-wrap">
	        ...
	        <div class="table-responsive">
	                ...
	                <tbody>
	                	...
	                	<?php $school = School::find($payment_history->school_id); ?>
	                		<tr>
	                			...
	                			<td class="link">
	                					<a href="<?php echo e(asset('public/assets/uploads/offline_payment/'.$payment_history->document_image)); ?>" download> <strong><?php echo e($payment_history->document_image); ?> </strong></a>
	                			</td>
	                			<td>
				...
				<?php echo $payment_histories->links(); ?>
...
<?php echo $__env->make('superadmin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ekattor/Ekattor8/resources/views/superadmin/subscription/pending.blade.php ENDPATH**/ ?>
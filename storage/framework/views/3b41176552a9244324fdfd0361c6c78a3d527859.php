        ...
        <div class="col-12">
            ...
            >
                ...
                <div class="export-btn-area">
                    <a href="javascript:;" class="export_btn" onclick="rightModal('<?php echo e(route('admin.events.open_modal')); ?>', '<?php echo e(get_phrase('Create Event')); ?>')"><i class="bi bi-plus"></i><?php echo e(get_phrase('Create Event')); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
  <div class="col-12">
    <div class="eSection-wrap-2">
        ...
        <form action="<?php echo e(route('admin.events.list')); ?>">
          <div
        ...
        <div class="table-responsive">
      	<table id="basic-datatable" class="table eTable">
      		...
      		<tbody>
                  ...
                  >
                    <li>
                      <a class="dropdown-item" href="javascript:;" onclick="rightModal('<?php echo e(route('admin.edit.event', ['id' => $event->id])); ?>', '<?php echo e(get_phrase('Update event')); ?>')"><?php echo e(get_phrase('Edit')); ?></a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="javascript:;" onclick="confirmModal('<?php echo e(route('admin.events.delete', ['id' => $event->id])); ?>', 'undefined');"><?php echo e(get_phrase('Delete')); ?></a>
                    </li>
                  </ul>
                </div>
  						</td>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ekattor/Ekattor8/resources/views/admin/events/events.blade.php ENDPATH**/ ?>
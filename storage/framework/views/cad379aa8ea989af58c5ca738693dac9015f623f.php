...
<head>
    ...
    <!-- all the css files -->
    <link rel="shortcut icon" href="<?php echo e(asset('public/assets/images/logo.png')); ?>">
    <!-- Bootstrap CSS -->
                ...
                <div class="tab-content payment_modalTab_content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade <?= $off; ?>" id="v-pills-offline" role="tabpanel" aria-labelledby="v-pills-offline-tab" tabindex="0">
                        ...
                        <div class="offline_payment_instruction">
                            <p>
                                <?php echo e(get_phrase('Instruction')); ?>: <?php echo e(get_phrase('Admin will review your payment document and then approve the Payment.')); ?>
...
<?php /**PATH /var/www/html/ekattor/Ekattor8/resources/views/admin/subscription/payment_gateway.blade.php ENDPATH**/ ?>
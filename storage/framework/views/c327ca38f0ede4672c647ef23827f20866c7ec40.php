                            ...
                            <div class="row">
                                <div class="col-md-3 text-center">
                                    ...
                                    <div class="eCard d-block text-center bg-light">
                                        <img src="<?php echo e(asset('public/assets/uploads/logo/'.get_settings('dark_logo'))); ?>" class="mx-4 my-5" width="200px"
                                            alt="...">
                                ...
                                <div class="col-md-3 text-center">
                                    ...
                                    <div class="eCard d-block text-center bg-secondary">
                                        <img src="<?php echo e(asset('public/assets/uploads/logo/'.get_settings('light_logo'))); ?>" class="mx-4 my-5" width="200px"
                                            alt="...">
                                        <div class="eCard-body">
                                ...
                                <div class="col-md-3 text-center">
                                    ...
                                    <div class="eCard d-block text-center bg-light">
                                        <img src="<?php echo e(asset('public/assets/uploads/logo/'.get_settings('favicon'))); ?>" class="mx-4 my-5" width="53px" height="60px"
                                            alt="...">
                                        <div class="eCard-body">
...
<?php echo $__env->make('superadmin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ekattor/Ekattor8/resources/views/superadmin/settings/system_settings.blade.php ENDPATH**/ ?>
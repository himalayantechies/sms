                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
                    ...
                    <div class="export-btn-area">
                        <a href="javascript:;" class="export_btn"
                            onclick="rightModal('{{ route('admin.syllabus.open_modal') }}', '{{ get_phrase('Create syllabus') }}')"><i
                                class="bi bi-plus"></i>{{ get_phrase('Add syllabus') }}</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="eSection-wrap">
                ...
                <form method="GET" class="d-block ajaxForm" action="{{ route('admin.syllabus.syllabus_list') }}">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-3 pt-2">
                            <button class="eBtn eBtn btn-secondary mt-4" type="submit"
                                id="filter_routine">{{ get_phrase('Filter') }}</button>
                        </div>
                ...
                @if (count($syllabuses) > 0)
                    <div class="table-responsive class_routine_content" style="padding-bottom: 6%;margin-top: 3em;">
                        <table id="basic-datatable" class="table eTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ asset('public/assets/uploads/syllabus') }}/{{ $syllabus['file'] }}"
                                            class="btn btn-primary btn-sm bi bi-download"
                                            download>{{ get_phrase(' Download') }}</a></td>
                                    <td>
                                            ...
                                            <ul
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="javascript:;"
                                                        onclick="rightModal('{{ route('admin.syllabus_edit_modal', ['id' => $syllabus['id']]) }}', '{{ get_phrase('Edit syllabus') }}')">{{ get_phrase('Edit') }}</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="javascript:;"
                                                        onclick="confirmModal('{{ route('admin.syllabus.delete', ['id' => $syllabus['id']]) }}', 'undefined')">{{ get_phrase('Delete') }}</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>

...
@section('content')
            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
                    ...
                    <div class="export-btn-area">
                        <a href="{{ route('admin.parent.create_form') }}"
                            class="export_btn">{{ get_phrase('Add Parent') }}</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="eSection-wrap-2">
                <div
                    ...
                    <form id="search_hide" action="{{ route('admin.parent') }}">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2">
                                ...
                                <li>
                                    <a class="dropdown-item" id="print" href="javascript:;"
                                        onclick="printableDiv('parent_lists')">{{ get_phrase('Print') }}</a>
                                </li>
                            </ul>
                        </div>
                    @endif
                                            ...
                                            <td>
                                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                                    ...
                                                    <div class="dAdmin_profile_name">
                                                        <h4>{{ $parent->name }}</h4>
                                                        <p><span>{{ get_phrase('Number of child') }}:</span>
                                                            {{ count($childs) }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="adminTable-action">
                                                    ...
                                                    <ul
                                                        ...
                                                        <li>
                                                            <a href="{{ route('admin.parent_edit_modal', ['id' => $parent->id]) }}"
                                                                class="dropdown-item">{{ get_phrase('Edit') }}</a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:;"
                                                                onclick="confirmModal('{{ route('admin.parent.delete', ['id' => $parent->id]) }}', 'undefined');">{{ get_phrase('Delete') }}</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </td>
    ...
    <script type="text/javascript">
        ...
        function Export() {
            ...
            var opt = {
                margin: 1,
                filename: 'parent_lists_{{ date('y-m-d') }}.pdf',
                image: {
                    type: 'jpeg',
                    quality: 0.98
                },

...
<div class="eForm-layouts">
    <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="{{ route('admin.setup.offline_exam.save', ['id' => $exam->id]) }}">
        ...
        <div class="row alignCenter">
                ...
                <div class="col-md-2 fpb-7"><label for="Theory" class="eForm-label">{{ get_phrase('Theory') }}<span class="required">*</span></label></div>  
                <div class="col-md-2 fpb-7"><label for="Theory" class="eForm-label">{{ get_phrase('Practical') }}<span class="required">*</span></label></div>  
                <div class="col-md-2 fpb-7"><label for="Theory" class="eForm-label">{{ get_phrase('Credit hours') }}<span class="required">*</span></label></div>  
                
        </div>
        <div class="row borders">
                <div class="col-md-2 fpb-7"><label for="Theory" class="eForm-label">{{ get_phrase('Subject') }}<span class="required">*</span></label></div>  
                <div class="col-md-1 fpb-7"><label for="Theory" class="eForm-label">{{ get_phrase('Full Marks') }}<span class="required">*</span></label></div>  
                <div class="col-md-1 fpb-7"><label for="Theory" class="eForm-label">{{ get_phrase('Pass Marks') }}<span class="required">*</span></label></div>  
                <div class="col-md-1 fpb-7"><label for="Theory" class="eForm-label">{{ get_phrase('Full Marks') }}<span class="required">*</span></label></div>  
                <div class="col-md-1 fpb-7"><label for="Theory" class="eForm-label">{{ get_phrase('Pass Marks') }}<span class="required">*</span></label></div>  
                <div class="col-md-1 fpb-7"><label for="Theory" class="eForm-label">{{ get_phrase('Theory') }}<span class="required">*</span></label></div>  
                <div class="col-md-1 fpb-7"><label for="Theory" class="eForm-label">{{ get_phrase('Practical') }}<span class="required">*</span></label></div>  

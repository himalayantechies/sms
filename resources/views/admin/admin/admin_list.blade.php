                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
                    ...
                    <div class="export-btn-area">
                        <a href="javascript:;" class="export_btn"
                            onclick="rightModal('{{ route('admin.open_modal') }}', 'Create Admin')">{{ get_phrase('Create Admin') }}</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2">
                                ...
                                <li>
                                    <a class="dropdown-item" id="print" href="javascript:;"
                                        onclick="printableDiv('admin_list')">{{ get_phrase('Print') }}</a>
                                </li>
                            </ul>
                        </div>
                    @endif
                                                ...
                                                <ul
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="javascript:;"
                                                            onclick="rightModal('{{ route('admin.open_edit_modal', ['id' => $admin->id]) }}', '{{ get_phrase('Edit Admin') }}')">{{ get_phrase('Edit') }}</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="javascript:;"
                                                            onclick="confirmModal('{{ route('admin.admin.delete', ['id' => $admin->id]) }}', 'undefined');">{{ get_phrase('Delete') }}</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>

...
<body>
    ...
    <div class="sidebar">
        <div class="logo-details mt-4 mb-3">
            <div class="img_wrapper">
                <img height="40px" class=""
                    src="{{ asset('public/assets/uploads/logo/' . get_settings('light_logo')) }}" alt="" />
            </div>
        </div>
        <div class="closeIcon">
        ...
        <ul class="nav-links">
            ...
            <li
                class="nav-links-li {{ request()->is('admin/exam_category*') || request()->is('admin/offline_exam*') || request()->is('admin/marks') ||  request()->is('admin/exam_attendance_create*') || request()->is('admin/grade') || request()->is('admin/promotion*')||request()->is('admin/manage/exam/*')||request()->is('admin/manage/exam') ? 'showMenu' : '' }}">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="{{ request()->is('admin/manage/exam/*')||request()->is('admin/manage/exam') ? 'active' : '' }}"
            ...
            <li
                class="nav-links-li {{ request()->is('admin/book*') || request()->is('admin/book_issue*') || request()->is('admin/noticeboard*') || request()->is('admin/subscription') || request()->is('admin/events/list*') ? 'showMenu' : '' }}">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
            ...
            <li
                ...
                <ul class="sub-menu">
                    ...
                    @if (addon_status('online_bundles') == 1 && addon_status('online_live_class') == 1)
                        <li>
                            <a class="{{ request()->is('admin/live_class_settings*') ? 'active' : '' }}"
                                href="{{ route('admin.live_class_key') }}">
                                <span>
    ...
    <script src="{{ asset('public/assets/calender/locales-all.js') }}"></script>

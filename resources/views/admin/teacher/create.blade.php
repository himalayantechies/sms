                        ...
                        <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm"
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12 mt-2">
                                        <label for="password"
                                            class="eForm-label form-label">{{ get_phrase('Password') }}</label>
                                        <input type="password" class="form-control eForm-control" id="password"
                                            name="password" placeholder="Provide teacher password" required>
                                    </div>
                                    <div class="col-md-6 col-sm-12 mt-2">

							...
							@foreach($subscriptions as $subscription)
		                		...
		                		<tr>
		                			...
		                			<td>
		                				...
		                				<a href="{{ asset('public/assets/uploads/offline_payment/'.$offline_tr_keys->document_file) }}" class="btn btn-light-success py-1 px-2 text-14px mt-1" data-bs-toggle="tooltip" title="Document file"><i class="bi bi-file-earmark-richtext-fill"></i></a>
		                			</td>

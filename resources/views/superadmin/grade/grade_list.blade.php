      ...
      <div class="col-12">
        ...
        >
          ...
          <div class="export-btn-area">
            <a href="javascript:;" class="export_btn" onclick="rightModal('{{ route('superadmin.grade.open_modal') }}', '{{ get_phrase('Create Grade') }}')">{{ get_phrase('Add grade') }}</a>
          </div>
        </div>
      </div>
    </div>
                             ...
                             <tr>
                                ...
                                <td class="text-start">
                                    <div class="adminTable-action ms-0">
                                        ...
                                        >
                                          <li>
                                            <a class="dropdown-item" href="javascript:;" onclick="rightModal('{{ route('superadmin.edit.grade', ['id' => $grade->id]) }}', '{{ get_phrase('Edit Grade') }}')">{{ get_phrase('Edit') }}</a>
                                          </li>
                                          <li>

...
<body>
    ...
    <ul class="nav-links">
      ...
      <li class="nav-links-li {{ request()->is('superadmin/class_list*') || request()->is('superadmin/subject/subjects*') || request()->is('superadmin/grade*')  ? 'showMenu':'' }}">
        <div class="iocn-link">
            <a href="#">
                <div class="sidebar_icon">
        ...
        <ul class="sub-menu">
            <li><a class="{{ (request()->is('superadmin/class_list*')) ? 'active' : '' }}" href="{{ route('superadmin.class_list') }}"><span>{{ get_phrase('Class List') }}</span></a></li>
            <li><a class="{{ (request()->is('superadmin/subject*')) ? 'active' : '' }}" href="{{ route('superadmin.subject_list') }}"><span>{{ get_phrase('Subjects') }}</span></a></li>
            <li><a class="{{ (request()->is('superadmin/grade*')) ? 'active' : '' }}" href="{{ route('superadmin.grade_list') }}"><span>{{ get_phrase('Grade') }}</span></a></li>
        </ul>
    </li>

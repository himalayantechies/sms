                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
                    ...
                    <div class="export-btn-area">
                        <a href="javascript:;" class="export_btn"
                            onclick="rightModal('{{ route('teacher.show_syllabus_modal') }}', '{{ get_phrase('Create syllabus') }}')"><i
                ...
                <div class="row mb-3">
                    <div class="syllabus_body">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-2">
                                <button class="eBtn eBtn btn-secondary"
                                    onclick="filter_syllabus()">{{ get_phrase('Filter') }}</button>
                            </div>
                        </div>
